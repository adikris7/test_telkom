...
<nav class="navbar navbar-inverse">
  ...
  <style>
    ...
    <div class="container">
      <form action ="<?php echo base_url('product/ActionUpdate')?>" method="POST">
        <div class="form-group row">
            <div class="col-sm-4">
                <label for="colFormLabel" class="col-sm-2 col-form-label-lg">Title</label>
            </div>
                <div class="col-sm-4">
                    <input type="text" class="form-control" name="title" value="<?php echo $queryProductDetail->title?>">
                </div>
        </div>
        <div class="form-group row">
            <div class="col-sm-4">  
            ...
            <div class="col-sm-4">
                <textarea class="form-control" name="description" value="<?php echo $queryProductDetail->description?>" rows="4 "></textarea>
            </div>
        </div>
        <div class="form-group row">
            <div class="col-sm-4">
                ...
                <div class="col-sm-4">
                    <input type="text" class="form-control" name="price" value="<?php echo $queryProductDetail->price?>">
                </div>
        </div>
        <div class="form-group row">
            <div class="col-sm-4">
                ...
                <div class="col-sm-4">
                    <input type="text" class="form-control" name="quantity" value="<?php echo $queryProductDetail->quantity?>">
                </div>
        </div>
        <div class="form-group row">
            <div class="col-sm-4">
            ...
            <div class="form-check col-sm-2">
                <input class="form-check-input" type="radio" name="featured" value="Featured" value="<?php echo $queryProductDetail->featured?>">
                <label class="form-check-label" for="inlineCheckbox1">Featured</label>
            </div>
            <div class="form-check col-sm-6">
                <input class="form-check-input" type="radio" name="featured" value="Unfeatured" value="<?php echo $queryProductDetail->featured?>">
        ...
        <div class="form-group row">
            ...
            <div class="form-check col-sm-2">
                <input class="form-check-input" type="radio" name="show" value="Show" value="<?php echo $queryProductDetail->show?>">
                <label class="form-check-label" for="inlineCheckbox1">Show</label>
            </div>
            <div class="form-check col-sm-6">
                <input class="form-check-input" type="radio" name="show" value="Hide" value="<?php echo $queryProductDetail->show?>">
